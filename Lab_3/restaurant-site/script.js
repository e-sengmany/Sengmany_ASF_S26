...
//B1. Menu Data
const MENU_ITEMS = [
  {Id: 1, Name: "Leon's Big Brother Bento", Description: "Crispy fried pork katsu made with japanese pank crumbs.", Price: 13.99, Category: "Lunch", Image: "./images/katsu_bento.png"},
  ...
  {Id: 3, Name: "Donnie's Baby Brother Bento", Description: "A mix of his Leon and Remi's bento. Half Crispy fried pork katsu and half grilled beef.", Price: 15.99, Category: "Lunch", Image: "https://via.placeholder.com/150"},
  {Id: 4, Name: "Shrimp Yakisoba Bento", Description: "Grilled garlic shrimp served over egg noodles with teriyaki seasoning.", Price: 13.99, Category: "Lunch", Image: "https://via.placeholder.com/150"},
  {Id: 5, Name: "Tomato Tofu Bento", Description: "Succulent soft tofu simmered together with sweet tomatoes. Garnished with chives.", Price: 11.99, Category: "Lunch", Image: "https://via.placeholder.com/150"},
  {Id: 6, Name: "Chicken Teriyaki Bento", Description: "Grilled chicken thighs seasoned in sweet teriyaki sauce.", Price: 12.99, Category: "Lunch", Image: "https://via.placeholder.com/150"},
  //Breakfast
  {Id: 7, Name: "Three Brothers Breakfast Bento", Description: "Comfort Food at its finest. SPAM, a fried egg and portuguese sausage over a bed a rice.", Price: 11.99, Category: "Breakfast", Image: "https://via.placeholder.com/150"},
  {Id: 8, Name: "Bento Burrito", Description: "Bento on the go! Options of pork katsu or beef with rice and fried carrots, rolled into a seaweed wrapped burrito", Price: 10.99, Category: "Breakfast", Image: "https://via.placeholder.com/150"},
  //Dinner
  {Id: 9, Name: "Steak Special Platter", Description: "Grilled wagyu and shiitake mushrooms paired with a bowl of rice. Includes miso soup and fried tempura.", Price: 19.99, Category: "Dinner", Image: "https://via.placeholder.com/150"},
  {Id: 10, Name: "Big Butterfish Platter  ", Description: "Miso marinated black cod grilled to buttery perfection. Served with a bowl of flavorful purple rice, miso soup and fried tempura", Price: 21.99, Category: "Dinner", Image: "https://via.placeholder.com/150"}
];

//B2. DOM Rendering with a table.
...
const cardsContainerLunch = document.getElementById("cardsContainerLunch");
const cardsContainerBreakfast = document.getElementById("cardsContainerBreakfast");
const cardsContainerDinner = document.getElementById("cardsContainerDinner");
...
//
// // Function to render all cards based on the product data
...
//   });
// }
// // Event listener for the input field to filter in real-time
// filterInput.addEventListener("keyup", filterCards);
//
// // Initial rendering of all cards when the page loads
// document.addEventListener("DOMContentLoaded", () => {
